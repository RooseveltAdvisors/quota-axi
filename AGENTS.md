...
- Claude multi-seat discovery and header-probe behavior, including the one-row seat-prefixed output shape and 60-second cache reuse, are documented in [README Multi-seat Claude](README.md#multi-seat-claude).
