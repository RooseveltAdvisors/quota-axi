...
| Alibaba                | Reads the local `bl` CLI's Alibaba Coding Plan usage summary; reports the plan name and each model's remaining percentage and reset time from the CLI's JSON output.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Alibaba        | The local `bl` CLI (`bl usage summary --days 1 --output json`); quota-axi never reads Alibaba credential files or exchanges refresh data                                                                                                                                                                                                                                                  |
