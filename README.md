...
| Alibaba                | Reads the Pi `alibaba-plan` credential and the Singapore DashScope usage/quota endpoint; reports the plan name and any defensible five-hour, seven-day, or monthly percentage/reset windows returned by the API.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| OpenCode Go            | Reads `opencode-go` (falling back to `opencode`) from OpenCode's `auth.json` and reports the provider's rolling, weekly, and monthly usage windows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Alibaba        | Pi's `$PI_CODING_AGENT_DIR/auth.json` (default `~/.pi/agent/auth.json`) for the literal `alibaba-plan` access credential; quota-axi never reads or exchanges its refresh data                                                                                                                                                                                                                                                  |
| OpenCode Go    | `$XDG_DATA_HOME/opencode/auth.json` when set, otherwise `~/.local/share/opencode/auth.json`, for a literal `opencode-go` key with `opencode` fallback                                                                                                                                                                                                                                                                          |
